...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("C1 = {} (should be 30)", sheet.get_a1("C1")?.as_float().unwrap_or(0.0));
    println!("C2 = {} (should be 75)", sheet.get_a1("C2")?.as_float().unwrap_or(0.0));
    println!("A3 = {} (should be 15)", sheet.get_a1("A3")?.as_float().unwrap_or(0.0));
    println!("B3 = {} (should be 35)", sheet.get_a1("B3")?.as_float().unwrap_or(0.0));
    println!("C3 = {} (should be 105)", sheet.get_a1("C3")?.as_float().unwrap_or(0.0));
    println!("D1 = {} (should be 12.5)", sheet.get_a1("D1")?.as_float().unwrap_or(0.0));
    println!("D2 = {} (should be 75)", sheet.get_a1("D2")?.as_float().unwrap_or(0.0));
    println!("D3 = {} (should be 5)", sheet.get_a1("D3")?.as_float().unwrap_or(0.0));
    println!();
    ...
    println!("New results:");
    println!("C1 = {} (should be 120)", sheet.get_a1("C1")?.as_float().unwrap_or(0.0));
    println!("A3 = {} (should be 105)", sheet.get_a1("A3")?.as_float().unwrap_or(0.0));
    println!("C3 = {} (should be 195)", sheet.get_a1("C3")?.as_float().unwrap_or(0.0));
    println!();
    ...
    println!("E1 = 'hello'");
    println!("E2 = 'world'");
    println!("E3 = CONCATENATE(E1, \" \", E2) = '{}'", sheet.get_a1("E3")?.as_str());
    println!("E4 = UPPER(E1) = '{}'", sheet.get_a1("E4")?.as_str());
    println!("E5 = LEN(E3) = {}", sheet.get_a1("E5")?.as_float().unwrap_or(0.0));
    println!();
    ...
    println!("F1 = IF(A1>50, \"high\", \"low\") = '{}'", sheet.get_a1("F1")?.as_str());
    println!("F2 = AND(A1>50, B1<100) = {}", sheet.get_a1("F2")?.as_bool().unwrap_or(false));
    println!("F3 = OR(A1<10, B1>10) = {}", sheet.get_a1("F3")?.as_bool().unwrap_or(false));
