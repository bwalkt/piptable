...
- [Getting Started](guide/getting-started.md)
  ...
  - [First Script](guide/first-script.md)
  
- [Core Concepts](guide/core-concepts.md)
  - [Variables and Types](guide/variables-types.md)
...
- [DSL Reference](reference/dsl/README.md)
  - [Statements](reference/dsl/statements.md)
    - [Variable Declaration](reference/dsl/dim.md)
  ...
  - [Expressions](reference/dsl/expressions.md)
    - [Operators](reference/dsl/operators.md)
    - [SQL Queries](reference/dsl/query.md)
    - [HTTP Fetch](reference/dsl/fetch.md)
    - [AI Ask](reference/dsl/ask.md)
...
- [Data Processing](cookbook/data-processing.md)
...
- [ETL Pipelines](cookbook/etl.md)
  ...
  - [Data Transformation](cookbook/transform.md)
  - [Data Export](cookbook/export.md)

- [Integration Examples](cookbook/integration.md)
  - [Python Integration](cookbook/python.md)
  - [HTTP APIs](cookbook/http-api.md)
  - [Database Queries](cookbook/database.md)
